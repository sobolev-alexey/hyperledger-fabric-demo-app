...
# Resources
* The source code of the IOTA Connector can be downloaded from this open-source [GitHub repository](https://github.com/iotaledger/HyperledgerFabric-IOTA-Connector).
* API Reference can be found [here](https://github.com/iotaledger/HyperledgerFabric-IOTA-Connector#api-reference).
